...
public class FeedbackService {
    ...
    public FeedbackDTO createFeedback(FeedbackDTO feedbackDTO) {
        ...
        // Execute design pattern - process feedback based on category
        try {
            FeedbackProcessor processor = feedbackFactory.getProcessor(savedFeedback.getCategory());
            processor.process(savedFeedback);
        } catch (Exception e) {
            System.err.println("Error processing feedback with design pattern: " + e.getMessage());
            // Don't fail the entire operation if design pattern processing fails
        }
